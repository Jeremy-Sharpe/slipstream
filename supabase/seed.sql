...
insert into public.conversations (id, deal_id, contact_id, channel, subject, direction, occurred_at, duration_seconds, source_external_id, raw_content, summary, sentiment, processing_status, extracted_fields, scorecard) values
  ('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', '20000000-0000-0000-0000-000000000001', 'call', 'Pricing & security review', 'inbound', '2026-09-12T01:42:00Z', 1104, 'fixture-call-northstar', E'Jeremy: How did the internal review go?\nMaya: Sales Ops and RevOps are aligned. Legal can move once we finish the security questionnaire. The $48,000 annual figure is approved. We need the CRM workflow live before October.\nJeremy: I will send the questionnaire and two options for a technical review next Tuesday.\nMaya: That works. I will bring our Salesforce admin.', 'Budget and internal alignment confirmed. Security review is the remaining gate before an October rollout.', 'positive', 'ready', '{"stage":{"value":"evaluation","confidence":0.96,"evidence":"Legal can move once we finish the security questionnaire"},"amount":{"value":48000,"confidence":0.99,"evidence":"The $48,000 annual figure is approved"}}', '{"overall":91,"discovery":88,"next_step":96,"objection_handling":90,"talk_ratio":52}'),
...
insert into public.transcript_segments (conversation_id, sequence, speaker, body, start_ms, end_ms, confidence) values
  ...
  ('40000000-0000-0000-0000-000000000001', 3, 'Jeremy', 'I will send the questionnaire and two options for a technical review next Tuesday.', 54000, 63000, 0.98),
  ('40000000-0000-0000-0000-000000000001', 4, 'Maya', 'That works. I will bring our Salesforce admin.', 63000, 70000, 0.97)
...
insert into public.notes (id, deal_id, conversation_id, kind, body, confidence, evidence) values
  ...
  ('50000000-0000-0000-0000-000000000002', '30000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000001', 'next_step', 'Send the questionnaire and book a technical review for Tuesday.', 0.95, '{"start_ms":54000,"end_ms":70000}')
on conflict (id) do nothing;
...
insert into public.activities (deal_id, contact_id, conversation_id, actor, action, fixture_key, details) values
  ...
  ('30000000-0000-0000-0000-000000000002', '20000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000002', 'slipstream', 'conversation.processed', 'fixture-activity-arcwell-processed', '{"pipeline":"fixture"}')
