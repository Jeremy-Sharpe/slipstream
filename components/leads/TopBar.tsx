...
export function TopBar({ searching, onRunSearch, brief, onBriefChange }: {
  ...
  return (
    <header className="flex h-14 shrink-0 items-center border-b border-line bg-card px-3">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger render={<button type="button" className="ml-3 flex items-center gap-2 rounded-md px-1 py-1 text-[15px] font-semibold text-ink hover:bg-muted focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none" />}>
      ...
      <div className="ml-auto flex items-center gap-2">
        <button
          ...
          onClick={onRunSearch}
          disabled={searching}
          className="flex items-center gap-1.5 rounded-lg bg-primary px-3.5 py-[9px] text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/85 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:outline-none disabled:opacity-70"
        >
          {searching ? <Loader2 className="size-3.5 animate-spin" strokeWidth={2} /> : <Sparkles className="size-3.5" strokeWidth={2} />}
        ...
        <button
          ...
          className="flex h-8 items-center gap-1.5 rounded-lg border border-line px-3 text-sm text-ink transition-colors hover:bg-muted focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
        >
