        ...
        <form className="flex flex-col gap-4" onSubmit={(e) => { e.preventDefault(); submit(); }}>
          <div className="grid grid-cols-2 gap-3">
            ...
            <label className={field}><span className={label}>Rep</span>
              <select value={rep} onChange={(e) => setRep(e.target.value as CalendarEvent["rep"])} className="h-9 rounded-md border border-border bg-card px-3 text-sm text-foreground outline-none focus-visible:ring-2 focus-visible:ring-primary">
