...
export function ConversationDetail({ call, others }: { call: CallRecord; others: Other[] }) {
  ...
  return (
    <div className="flex min-h-[calc(100vh-64px)] flex-col bg-page">
      ...
      <div className="mx-3 mt-4 flex flex-wrap items-center gap-3 rounded-lg border border-line bg-card px-4 py-3 shadow-[0_1px_2px_rgba(17,24,39,0.04)] sm:mx-6 sm:mt-5">
      ...
      <div className="grid flex-1 grid-cols-1 gap-4 px-3 py-4 lg:grid-cols-[minmax(0,2fr)_minmax(360px,1fr)] lg:gap-6 lg:px-6 lg:py-6">
        ...
        <div id="crm-writeback" className="scroll-mt-6 self-start rounded-xl border border-line bg-card p-4 shadow-[0_1px_2px_rgba(17,24,39,0.06)] sm:p-6 lg:sticky lg:top-6">
