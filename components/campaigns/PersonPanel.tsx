                ...
                <div className="flex flex-col gap-1.5 px-3 py-2.5">
                  {s.channel === "email" && (
                    <input
                      ...
                      className="h-8 rounded-md border border-transparent bg-transparent px-1 text-[13px] font-medium text-foreground outline-none hover:border-border focus:border-border focus:ring-2 focus:ring-primary"
                    />
                  )}
                  <textarea
                    value={copy.body}
                    ...
                    className="resize-y rounded-md border border-transparent bg-transparent px-1 py-1 text-[13px] leading-5 text-foreground outline-none hover:border-border focus:border-border focus:ring-2 focus:ring-primary"
                  />
                </div>
              </li>
            );
