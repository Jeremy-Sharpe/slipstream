...
const CELL = "h-[49px] border-r border-b border-legacy-line px-3 text-base text-legacy-ink truncate";
    ...
    <>
      ...
      >
        <td className={cn(CELL, "px-0")}>
          <span className="flex h-full items-center gap-1.5 pl-3 text-legacy-ink">
        ...
        <td className="h-[49px] border-b border-legacy-line" />
      </tr>
      <tr aria-hidden={!open}>
        <td colSpan={9} className="p-0">
          <div
            className={cn("grid overflow-hidden transition-[grid-template-rows] duration-150 motion-reduce:transition-none", open ? "grid-rows-[1fr] border-b border-legacy-line" : "grid-rows-[0fr]")}
          >
