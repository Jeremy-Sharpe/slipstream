...
- Jeremy's agent is working on `feat/unified-icp-evidence`: ICP derivation will use outcome-labelled CRM deals enriched with bounded call and email evidence while the twelve-call fixture benchmark remains unchanged. Other people should avoid changing the ICP store contract or memory CRM mirroring until this lane lands, and should record the public demo video.
