...
- Jeremy's agent is working on `feat/coach-release`: GitHub Actions will test and package unsigned Linux, macOS and Windows coach installers from a manual run or version tag, with no signing credentials in the repository. Other people should record the public demo video and leave the coach packaging configuration to this lane.
