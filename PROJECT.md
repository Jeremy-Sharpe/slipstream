...
- Jeremy's agent is working on `feat/crm-webhook-sync`: approved call extraction will be deliverable to the team's existing CRM through an authenticated, signed, idempotent webhook contract, keeping HubSpot, Salesforce, Pipedrive and automation middleware behind one replaceable seam. Other people should record the public demo video and avoid changing the CRM sync files until this lane lands.
