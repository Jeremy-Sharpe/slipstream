...
- Jeremy's agent is working on `feat/web-wire-scorecards`: per-call scoring and aggregate playbook generation are the last unwired backend intelligence surfaces. Other people should avoid the conversation scorecard and Intelligence playbook components while this branch is active, and record the public demo video instead.
