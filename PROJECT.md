...
- Jeremy's agent is working on `feat/playbook-store`: aggregate playbooks will receive a deterministic cohort revision, persist through the repository boundary, and hydrate the Intelligence lens from the latest verified cohort instead of disappearing after generation. Other people should record the public demo video and avoid changing scorecard/playbook contracts in parallel.
