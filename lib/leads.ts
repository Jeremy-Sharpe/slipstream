...
const POOL: Seed[] = [
  ...
  { company: "Sunbury Building Certifiers", contact: "Grant Leyland", title: "Director", location: "Sunbury, VIC", industry: "Building certification", headcount: 25, trigger: "Essential Eight evidence", call: "Northstar Labs", t: "0:15", quote: "We're a lab planning and architecture practice, forty-two people now.", value: "Insurer wants Essential Eight evidence", subject: "Essential Eight evidence for the renewal", similar: "an insurer asking for Essential Eight evidence", industryCall: "Elm & Ledger Accounting" },
];

// One "who they are" line per won call, for the Industry evidence row. Each
// pool entry cites it from a different won call than its trigger quote.
