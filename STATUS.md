...
| Thing | Where | State |
|---|---|---|
| Production UI | https://slipstream.3-104-149-193.sslip.io | Standalone Next web revision `f8781fc` is live behind Caddy and includes the PR #56 value cards/mobile shell plus the PR #57 outcome shock. Full production contract smoke passes; a real Chromium click propagated a hypothetical win across Signal, Detect, Protect and Adapt while confirming live state was unchanged. The service is active with zero restarts. |
