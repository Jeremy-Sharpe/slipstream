...
| `api-skeleton` | FastAPI app, settings, Supabase client, health route, CORS for the web origin, VPS deploy | `api/` | Jeremy's agent | feat/api-skeleton | done | 18 API tests pass; hostile review findings fixed; deploying to Jeremy's VPS behind HTTPS |
