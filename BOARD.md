...
| `coach-shell` | Fork Cheating Daddy into `coach/`, remove Gemini, connect to the API WebSocket, keep overlay and audio capture | `coach/` | Jeremy's agent | feat/coach-shell | in progress | Adapt the GPL-3.0 Electron overlay for legitimate sales coaching, remove Gemini, preserve attribution, and connect audio/transcript events to the deployed Slipstream coach protocol |
