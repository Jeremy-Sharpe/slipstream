...
**Not run tonight.** The shared OpenRouter key sits on a five-dollar credit account with about a dollar and a half left; four models in flight returned 402 and the run was stopped. The open-weight and Claude models are running one at a time and are appended here when they finish; a top-up is needed before the full nine-model comparison with billed cost.
