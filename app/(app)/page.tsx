    ...
    <div className="flex h-[calc(100vh-64px)] flex-col">
      <div className="flex shrink-0 items-center justify-between px-11 pt-[34px]">
        <div className="flex items-center gap-4">
          <span className="flex size-[46px] items-center justify-center rounded-lg bg-icon-well text-foreground"><MessageSquare className="size-[22px]" strokeWidth={1.75} /></span>
